...
export default function Navbar() {
    ...
    return (
        ...
        ${isOpen ? "h-screen" : "transition-all ease-out duration-700 w-0 h-16"}`}>
            ...
            <a href='#headerRef' onClick={toggleNav} className="max-h-24 flex justify-center pl-3 md:p-0 md:flex-1 md:h-full md:w-10/12 text-center]">
            ...
            ${isOpen ? "transition-all ease-in duration-700 top-0 right-0 h-screen w-screen rounded-bl-none" :
                ...
                <a href='#trabajosRef' onClick={toggleNav}
                    className="flex-1 font-bold hover:text-red-500 hover:ease-in-out hover:rounded-b-2xl hover:border-solid hover:border-collapse  duration-300 hover:scale-110">
                    TRABAJOS
                </a>
                ...
                <a href='#contactoRef' onClick={toggleNav} className="flex-1 font-bold">
                    <span className="md:py-1 px-3 md:bg-red-500 hover:ease-in-out hover:border-solid hover:border-collapse duration-300 hover:scale-110">
                        CONTACTO
                    </span>
                </a>
